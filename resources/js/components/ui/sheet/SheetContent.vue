...
<template>
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        class="ring-offset-background focus:ring-ring data-[state=open]:bg-foreground/3 absolute top-4 right-4 rounded-xs opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none"
      >
        <PhX class="size-4" />
